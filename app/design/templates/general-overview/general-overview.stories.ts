...
const dummyCreatures: OverviewItem[] =  [
    {
      ...
      "description": "A wolf infused by chaos. The final stage of its transformation into a being that embodies chaos. Can teleport and whip its tentacles around.",
      "pk": 3,
    ...
    {
      "article_type": "creature",
      "description": "Chimeras are unnatural magical amalgamations of other creatures, such as dragons, lions and goats. These creatures were created by the academy once upon a time through dragon's blood, back in the...",
      "pk": 16,
      "name": "Chimera",
      "name_full": "Chimera",
      "campaign_details": { "name": "Aldrune", "pk": 1 },
    ...
    {
      "article_type": "creature",
      "description": "Wyverns in general are creatures that work with venoms. However, coastal wyverns are more brutish than there more inland-cousins. They rely on shock-tactics and frontal assaults to kill their prety, using...",
      "pk": 10,
      "name": "Coastal Wyvern",
    ...
    {
      "article_type": "creature",
      "description": "Devils are a wide spread group of creatures. They, particularly the warrior devils among them, define themselves almost entirely by participating in the bloodwar.\nThose that do not participate are ostracized as...",
      "pk": 14,
      "name": "Devil Outcasts",
    ...
    {
      "article_type": "creature",
      "description": "Dragons are less creatures and more forces of nature. It would be more apt to describe them to a sentient storm or earthquake in scale of their power than to a...",
      "pk": 8,
      "name": "Dragons",
      "name_full": "Dragons",
      "campaign_details": { "name": "Aldrune", "pk": 1 },
    ...
    {
      "article_type": "creature",
      "description": "A gigantic type of worm that appears to reside within the ashen grey plane north of the dried out riverbed. We have seen one of them in there so far. Distinctly...",
      "pk": 23,
    ...
    {
      "article_type": "creature",
      "description": "A bat like creature the size of a man. Bat-like wings, but also faceless. It evades divine sense and can't be seen normally. Does disappear at the sight of daylight apparently....",
      "pk": 34,
      "name": "Gaunt",
      "name_full": "Gaunt",
      "campaign_details": { "name": "Aldrune", "pk": 1 },
    ...
    {
      "article_type": "creature",
      "description": "A creature first encountered in the marsh-waters of the Wildheart Woodlands near the hag's camp. Massively oversized leeches, easily reaching the size of a wolf that are luckily blind, but easily...",
      "pk": 18,
      "name": "Giant Leech",
...
const dummyOrganizations: OverviewItem[] = [
  {
      ...
      "description": " Magic is Chaos and sometimes people are in touch with this force. Though understanding and control we order the Chaos. It is only when we allow it to overcome us that...",
      "pk": 17,
  ...
  {
      "article_type": "organization",
      "description": " The ruling family of Hallan. Loyal to Duke Aspen. Somewhat politically powerful as Hallan is an important trading post. Further make an effort to be very presentable and are well-practiced in...",
      "pk": 13,
  ...
  {
      "article_type": "organization",
      "description": " A village made up of an unknown species, located somewhere in the desert hellscape we were telported to after our fight with Prince Somnis.\nRoughly somewhere upwards of 50 people in size,...",
      "pk": 41,
  ...
  {
      "article_type": "organization",
      "description": " The group of archangels that have their own stars. All of them have their own solar systems, as Lucifer's planetoid had.\nFen managed to find where Lucifer's star used to be.  Fen...",
      "pk": 55,
  ...
  {
      "article_type": "organization",
      "description": " An institution designed to create a diverse and thus group of individuals from all stratum who will determine who will be the next King when no clear line of succession is...",
      "pk": 18,
  ...
  {
      "article_type": "organization",
      "description": " A group of scoundrels in Merren that are of key importance. Their leader is pretty well liked within the underground ecosystem, as they have the best scouts. She used to work...",
      "pk": 37,
...
].map(entry => ({...entry, getAbsoluteRouterUrl: () => '/organization/123'}));

const dummyItems: OverviewItem[] = [
  {
      "article_type": "item",
      "description": " These belong to head researcher Agrippina. They detail the complex we found an illithid base in. The core at the bottom is the \"cold gold\", a source of immense celestial power...",
      "pk": 159,
  ...
  {
      "article_type": "item",
      "description": " A book gained from the Academy Wing in Galway, specifically a small library room with 4 shelves and exotic birds.\nHas a strange humanoid shark person on the cover, which I know...",
      "pk": 149,
  ...
  {
      "article_type": "item",
      "description": " A set of adamantine plate that was on the violet storm when Murtagh acquired it.",
      "pk": 55,
  ...
  {
      "article_type": "item",
      "description": " An ornate lamp always hanging on Rhiannon's hip. It is larger on the inside, giving it enough space to be a beautiful home to Ahjuu as well as her complete collection...",
      "pk": 18,
  ...
  {
      "article_type": "item",
      "description": " These originally 4 shards were found in the vault of the temple of Anubis. They are consumable items.\nAs a bonus action they transform into any melee weapon. They deal an additional...",
      "pk": 109,
  ...
  {
      "article_type": "item",
      "description": " A magical strange cross-bow like weapon found in the ruins of Salus, specifically in a safe in the Oversight section.\nIt functions as a crossbow or a pistol would. It has 2...",
      "pk": 126,
  ...
  {
      "article_type": "item",
      "description": " A booklet that is synced up with Aridhel's personal diary. It updates itself every dawn and its contents are not to be shared. Through it she shares commands, information, personal musings...",
      "pk": 72,
  ...
  {
      "article_type": "item",
      "description": " Forged in the Anubis temple. +1 Studded leather armor.While attuned to it you can once per long rest cast Bless as a bonus action targeting only yourself, lasting 1 hour without...",
      "pk": 145,
  ...
  {
      "article_type": "item",
      "description": " The sword that held Lancelot's soul previously, having a huge capacity for magical energies of 300 charges. It is currently inert (100/300). When anyone touches the sword while casting a spell...",
      "pk": 86,
      "name_full": "Arondight",
      "name": "Arondight",
      "campaign_details": { "name": "Aldrune", "pk": 1 },
  ...
  {
      "article_type": "item",
      "description": " A stake made of Aspenwood. If driven through the heart of a vampire, instead of killing them, it paralyzes them.",
      "pk": 98,
  ...
  {
      "article_type": "item",
      "description": " This glorious +3 axe is so full of magical energy it feels almost like it's about to burst to anyone with any magical sense in the vicinity. Rhiannon gained it by...",
      "pk": 94,
  ...
  {
      "article_type": "item",
      "description": " The assortment of gifts given by friends, acquaintances, and possible enemies on the wrong date celebrating Bathilde's birth.\nThese items include:\n\nA set of 7 rings given by Fen (3 black, 3 gold,...",
      "pk": 80,
  ...
  {
      "article_type": "item",
      "description": " A beautifully made item made of silver and jet to resemble a raven with a W.\nBestowed by King Mordred as a birthday gift and reward for getting the woad at least...",
      "pk": 79,
  ...
  {
      "article_type": "item",
      "description": " A moss that encourages blood clotting, helping to close up wounds quickly.",
      "pk": 9,
  ...
  {
      "article_type": "item",
      "description": " A leather-bound “book” that is more a collection of 19 trays, each containing a single scroll of a different spell. The spells it contains are denoted as:\n\n“Orb” (Chromatic Orb)\n“Cone” (Cone of...",
      "pk": 57,
  ...
  {
      "article_type": "item",
      "description": " This magical handaxe returns to its wielder at the end of a round after it has been thrown. It retains its normal range of 20/60. Bought from a Stricken blacksmith for...",
      "pk": 130,
...
const dummyDiaryentries: OverviewItem[] = [
  {
    ...
    "description": " Back in my Era I was brought to the Dragon Chapel to help a cult of humans see if the dragon they worshipped would attain godhood as they believed, instead they...",
    "pk": 49,
  ...
  {
    "article_type": "diaryentry",
    "description": " One of the first things I remembered being taught by Blaire once she took me in was about one of the biggest misconceptions surrounding following Silvanus. She mentioned while being in...",
    "pk": 31,
  ...
  {
      "article_type": "diaryentry",
      "description": " After Caitriona had some dinner with her parents, Rhi and I grab Ciatriona and go on a walk. There we confront her with that she needs to make a choice regarding...",
      "pk": 109,
  ...
  {
      "article_type": "diaryentry",
      "description": " We try to move the ball, Rhi touches it, get's ashed by it. We decide to stay the night until she's back and figure out how we can further break this...",
      "pk": 106,
  ...
  {
      "article_type": "diaryentry",
      "description": " Bathilde wakes up again and tells us what she learned, that she is a niece of Penwaithe and the last hair of the Pendraig family. Upon hearing that, Merlin jokingly makes...",
      "pk": 105,
  ...
  {
      "article_type": "diaryentry",
      "description": " We find ourselves in the Aspen Estate, owned by Lady Bathilde Aspen, basically Bathilde on a really, really bad trip.\nWe see Lady Bathilde Aspen, a suit jacket and a dress, red,...",
      "pk": 104,
  ...
  {
      "article_type": "diaryentry",
      "description": " With the giant angel, which turns out to be called an archaic defeated, we have a brief respite, meeting up with Morgana and Mordred to talk about our next steps and...",
      "pk": 103,
  ...
  {
      "article_type": "diaryentry",
      "description": " Fen meets with Mordred. Mordred acknowledges we bombed an illithid encampment with their weapon and thanks us for it.\nThey talk shop and war logistics, pondering whether to remove people from other...",
      "pk": 102,
  ...
  {
      "article_type": "diaryentry",
      "description": " Still breathing heavily Rhiannon's teleportation spell finishes and we find ourselves back in Etruscan, within the very familiar building of the guild of many steps.\nWith the life-and-death threat over, Rhi is...",
      "pk": 101,
  ...
  {
      "article_type": "diaryentry",
      "description": " Within the strange world of Hotel California, our heroes, agents in a detective agency, work on solving a murder mystery on orders of madame, in a 1950's kinda city with guns...",
      "pk": 99,
  ...
  {
      "article_type": "diaryentry",
      "description": " The entire session consists solely of us fighting Hoert and his companions and creatures. Murtagh does send a message to Morgana at the start of the fight, asking what the fuck...",
      "pk": 100,
  ...
  {
      "article_type": "diaryentry",
      "description": " The day of the mission arrives (In the meantime I sent 2 bars of gold to the local church of Morrigan for funds) and we meet in the morning to talk...",
      "pk": 98,
  ...
  {
      "article_type": "diaryentry",
      "description": " The morning after last nights welcome in the grove approaches eventually. We spend a long part of the morning asking Merlin quite a lot of questions (see last session), drinking tea...",
      "pk": 97,
  ...
  {
      "article_type": "diaryentry",
      "description": " This session was held short and thus mostly a QA for various things. The following questions were asked / information was gained:\n\nIs there a dangerous chaos portal in the Firbolg cave?\n\nNo\n\n\nWould...",
      "pk": 96,
  ...
  {
      "article_type": "diaryentry",
      "description": " After licking our wounds for a bit and deciding to leave the crystal-entrapped people be, we take our leave. Though it's a bit odd when Murtagh suddenly manifests a sheathe for...",
      "pk": 95,
  ...
  {
      "article_type": "diaryentry",
      "description": " We follow Fen down the staircase into the bowels of whatever this secret space is. Soon enough we find another chamber. Its walls are of a brown stone, tinged with an...",
      "pk": 94,
...
const Template: StoryFn<GeneralOverviewComponent> = (args: GeneralOverviewComponent) => ({ 
  props: {
    ...args,
...
CharactersWithoutPlayerCharacters.args = {
  entries: dummyCharacters.map(character => ({...character, player_character: false})),
}

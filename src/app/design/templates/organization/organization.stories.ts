...
const dummyOrganization: Organization = {
  ...
  leader: "Sir Cedric",
  headquarter: 456,
  headquarter_details: { name: "Castle Silverkeep", parent_name: "Kingdom of Arathia", pk: 456, name_full: "Castle Silverkeep, Kingdom of Arathia" },
  members: [
    { name: "Sir Cedric", pk: 789, alive: true, organization_id: 123, role: "Grandmaster" },
    { name: "Lady Elspeth", pk: 790, alive: true, organization_id: 123, role: "Commander" },
    { name: "Sir Richard", pk: 791, alive: false, organization_id: 123, role: "Knight" },
  ],
  images: [
    { pk: 234, image: "/breeds/mastiff-tibetan/n02108551_5830.jpg", name: "Order Emblem", organization_article: 123, article_type: "Organization" },
    { pk: 235, image: "/breeds/mastiff-tibetan/n02108551_5830.jpg", name: "Order Emblem", organization_article: 123, article_type: "Organization" },
  ],
  campaign: 1,
...
const Template: StoryFn<OrganizationComponent> = (args: OrganizationComponent) => ({ 
  props: {
    ...args,

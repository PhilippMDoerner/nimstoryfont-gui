...
const dummySession: Session = {
  ...
  has_recording: true,
  diaryentries: [
    { author_name: 'John', name: 'The party met in a tavern and decided to take on the quest to slay the dragon.' },
    { author_name: 'Sarah', name: 'The party encountered some goblins on their way to the dragon\'s lair.' },
    { author_name: 'Bob', name: 'The party defeated the dragon and claimed its treasure hoard.' },
  ],
  campaign: 2,

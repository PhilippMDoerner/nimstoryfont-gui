...
const dummyCharacter: Character = {
  ...
  "description": "<p>A purple-skinned, golden-eyed Tiefling that managed to have many a spirit as his servant and commanded unimaginable power. Tended to wear simple clothing, but a lot of golden jewelry.</p>\r\n<p>Among his most powerful servants were the primordial four and the unholy trinity, which he later sealed away.</p>",
          ...
          "encounterConnections": [
              {
                  ...
                  "encounter_details": {
                      ...
                      "name_full": "Main Session 53 - Knowledge of Illithids and releasing fiends",
                      "pk": 689
                  },
                  "character": 83,
                  "character_details": {
...
const Template: StoryFn<CharacterComponent> = (args: CharacterComponent) => ({ 
  props: {
    ...args,

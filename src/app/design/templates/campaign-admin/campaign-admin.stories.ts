...
import { dateMessage, dateValidator, requiredMessage, requiredValidator } from 'src/app/_services/formly/validators';
import { dummyCampaign, dummyStatistics } from 'src/app/_services/utils/campaign.mock.service';
...
const Template: StoryFn<CampaignAdminComponent> = (args: CampaignAdminComponent) => ({ 
  props: {
    ...args,

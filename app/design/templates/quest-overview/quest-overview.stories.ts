...
const dummyQuests: OverviewItem[] = [
  ...
  },
  {
    ...
    name_full: 'The Dragon\'s Hoard - A quest to recover a stolen treasure hoard',
    description: 'The players must find and recover a stolen treasure hoard from a fearsome dragon who is guarding it in a remote mountain cave',
  ...
  },
  {
    ...
    name_full: 'The Lost Artifact - A quest to recover a powerful magical artifact',
    description: 'The players are hired to find and recover a powerful magical artifact that has been lost for centuries',
  ...
  },
  {
    ...
    description: 'The players are hired to find and defeat a powerful bandit leader who has been raiding caravans and terrorizing the local towns',
  ...
  },
  {
    ...
    description: 'The players are hired to investigate a mysterious mine that was abandoned years ago',
  ...
  },
  {
    ...
    description: 'The players are hired to break a powerful curse that has plagued a local castle for generations',
  ...
  },
  {
    ...
    description: 'The players are hired to find and defeat a powerful goblin leader who has been raiding villages and hoarding treasure',
  ...
  },
  {
    ...
    description: 'The players are hired to explore a dangerous forest that is said to be home to powerful monsters and ancient magic',
  ...
  },
  {
    ...
    description: 'The players are hired to investigate a haunted mansion that is said to be cursed and haunted by vengeful spirits',
...
const Template: StoryFn<QuestOverviewComponent> = (args: QuestOverviewComponent) => ({ 
  props: {
    ...args,
  },
});

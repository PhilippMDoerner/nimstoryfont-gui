...
const Template: StoryFn<CharacterCreateUpdateComponent> = (args: CharacterCreateUpdateComponent) => ({ 
  props: {
    ...args,
...
OutdatedUpdate.args = {
  ...
  serverModel: {
    ...
    description: dummyCharacter.description + " <strong> Some text added by somebody else <strong>",
  }
}

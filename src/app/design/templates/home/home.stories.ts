...
const dummyOverview: OverviewItem[] = [
  ...
  },
  {
    ...
    session_details: {pk: 234, session_number: 1, is_main_session: true, is_main_session_int: 1},
  ...
  },
  {
    ...
    description: 'A bastard sword made of Valyrian steel, with a hilt fashioned like a wolf',
  ...
  },
  {
    ...
    description: 'The party is ambushed while travelling on the Kingsroad, by a group of bandits led by a dangerous outlaw',
  ...
  },
  {
    ...
    description: 'A spell that creates a powerful explosion of fire, causing damage to all creatures within a certain area',
  ...
  },
  {
    ...
    name_full: 'Critical Hits and Misses - Rules for critical hits and misses in combat',
    description: 'A set of rules for determining the effects of critical hits and misses during combat',
  ...
  },
  {
    ...
    description: 'The Thieves Guild is a secret organization of skilled thieves, who operate in the shadows and have their own code of honor',
  ...
  },
  {
    ...
    name: 'Beholder',
    name_full: 'Beholder - A monstrous creature with numerous eyes and deadly abilities',
    description: 'The Beholder is a monstrous creature with a large central eye and numerous smaller eyes around its head, each with a different deadly ability',
...
const Template: StoryFn<HomeComponent> = (args: HomeComponent) => ({ 
  props: {
    ...args,

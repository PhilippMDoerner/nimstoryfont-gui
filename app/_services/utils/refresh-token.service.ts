...
export class RefreshTokenService {
  ...
  private refreshAccessTokenSubject: Subject<string | undefined> = new BehaviorSubject<string | undefined>(undefined);
  ...
  private startWaitForRefreshState(): void{
    ...
    this.refreshAccessTokenSubject.next(undefined);
  }

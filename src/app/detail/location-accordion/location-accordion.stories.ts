...
const dummyLocations: Location[] = [
  ...
  {    
    ...
    description: "<p>The Dragon's Lair is a massive cavern deep within a mountain range, filled with glittering treasures and the bones of unlucky adventurers. The lair is home to a powerful dragon, feared throughout the land for its fiery breath and razor-sharp claws.</p><p>Legends say that the dragon guards a magical artifact of immense power, capable of granting wishes or unleashing destruction upon the world. Many brave heroes have attempted to slay the dragon and claim the artifact, but none have returned alive.</p><p>The lair itself is a maze of twisting tunnels and treacherous traps, with pools of lava and poisonous gas waiting to ensnare the unwary. Only the bravest and most skilled adventurers stand a chance of surviving the dragon's deadly lair.</p>",
    parent_location: 2,    
    images: [],
    parent_location_details: {
      pk: 2,
    ...
    sublocations: [
      {
        ...
        pk: 890,
        characters: [{name: "Zoltar", pk: 123, name_full: "Zoltar, the Sorcerer"}],
        name_full: "The Sorcerer's Study in the Black Tower",
        description: "A dark and musty room filled with dusty tomes and strange artifacts.",
        parent_location: 6,
        getAbsoluteRouterUrl: () => "/locations/the-kingdom-of-eldrid",
      }
    ],
    marker_details: [{map: "The Kingdom of Norgard", map_icon: "https://example.com/black-tower-icon.png"}],
    getAbsoluteRouterUrl: () => "/locations/the-kingdom-of-eldrid",
    getAbsoluteRouterUrlForParentLocation: () => "/locations/the-kingdom-of-norgard"
  },
];
...
const Template: StoryFn<LocationAccordionComponent> = (args: LocationAccordionComponent) => ({ 
  props: {
    ...args,
